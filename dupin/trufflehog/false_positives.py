...
cdn_guardian_tv   = re.compile('https?://cdn.theguardian.tv/')
...
def false_positive(line):
    ...
    if yarn.search(line) or data_url.search(line) or flow_sig.search(line) or \
            ...
            github_reference.search(line) or blend64.search(line) or static_guim.search(line) or \
            cdn_guardian_tv.search(line):
        return True
    else:
        return False
